...
import sys
import io
from butterup.__main__ import main
...
def test_main_with_input_file(tmp_path, capsys):
    ...
    sys.argv = ["butterup", str(input_file)]
    main()
...
def test_main_with_output_file(tmp_path, capsys):
    ...
    sys.argv = ["butterup", str(input_file), "-o", str(output_file)]
    main()
    captured = capsys.readouterr()
...
def test_main_with_nonexistent_input_file(capsys):
    sys.argv = ["butterup", "nonexistent_file.btr"]
